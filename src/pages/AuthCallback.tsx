    ...
    const handleCallback = async () => {
      try {
        ...
        if (session?.provider_token) {
          ...
          // Store in database for persistence (don't block on this)
          supabase
            .from('oauth_tokens')
            .upsert({
        ...
        console.error("[AuthCallback] Error in callback handler:", err);
        // On error, redirect to home instead of showing error screen
        navigate('/');
      }
    };
