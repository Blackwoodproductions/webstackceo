        ...
        <section className="py-24">
          <div className="container mx-auto px-6 max-w-6xl">
            ...
            >
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                Our visitor intelligence dashboard gives you real-time insights into your website traffic, visitor flow, and engagement metrics.
              </p>
            </motion.div>
            ...
            >
              {[
                { title: "Real-Time Flow", description: "See exactly how visitors navigate through your site with live path visualization" },
                { title: "Engagement Scoring", description: "Automatic heat-mapping shows which pages drive the most engagement" },
                { title: "AI Sales Center", description: "Integrated chat and lead management to convert visitors into customers" },
              ].map((item, index) => (
