...
const MarketingDashboard = () => {
  ...
  const [gmbBusinessCategory, setGmbBusinessCategory] = useState('');
  const [gmbBusinessAddress, setGmbBusinessAddress] = useState('');
  const [gmbBusinessPhone, setGmbBusinessPhone] = useState('');
                    ...
                    <div className="flex items-center justify-between max-w-2xl mx-auto">
                      {[
                        ...
                        <div key={item.step} className="flex items-center">
                          <div className={`flex items-center gap-2 ${gmbOnboardingStep >= item.step ? 'text-primary' : 'text-muted-foreground'}`}>
                            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${
                              gmbOnboardingStep > item.step 
                                ? 'bg-primary text-primary-foreground' 
                                : gmbOnboardingStep === item.step 
                                  ? 'bg-primary/20 text-primary border-2 border-primary' 
                                  : 'bg-muted text-muted-foreground'
                            }`}>
                              {gmbOnboardingStep > item.step ? <CheckCircle className="w-4 h-4" /> : item.step}
                            </div>
                            <span className="text-sm font-medium hidden sm:block">{item.label}</span>
                          </div>
                          {idx < 2 && (
                            <div className={`w-12 sm:w-24 h-0.5 mx-2 ${gmbOnboardingStep > item.step ? 'bg-primary' : 'bg-muted'}`} />
                          )}
                        </div>
                      ))}
                    </div>
                    ...
                    {gmbOnboardingStep === 1 && (
                      <div className="max-w-xl mx-auto space-y-6">
                        <div className="text-center mb-6">
                          <h3 className="text-xl font-bold mb-2">Tell us about your business</h3>
                          <p className="text-sm text-muted-foreground">
                            We'll help you create a Google Business Profile for <span className="font-medium text-foreground">{selectedTrackedDomain || selectedDomainKey}</span>
                          </p>
                        </div>
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <Input
                              ...
                              onChange={(e) => setGmbBusinessName(e.target.value)}
                            />
                          </div>
                          <div>
                            <label className="text-sm font-medium mb-1.5 block">Business Category</label>
                            <Select value={gmbBusinessCategory} onValueChange={setGmbBusinessCategory}>
                              <SelectTrigger>
                          ...
                          <div>
                            ...
                            <Input
                              ...
                              value={gmbBusinessPhone}
                              onChange={(e) => setGmbBusinessPhone(e.target.value)}
                            />
                          </div>
                        </div>

                        <div className="flex justify-between pt-4">
                          <Button variant="outline" onClick={() => setGmbOnboardingStep(0)}>
                            Cancel
                          </Button>
                          <Button
                            onClick={() => setGmbOnboardingStep(2)}
                            disabled={!gmbBusinessName || !gmbBusinessCategory}
                            className="bg-gradient-to-r from-blue-600 to-green-600 hover:from-blue-700 hover:to-green-700"
                          >
                            Continue
                    ...
                    {gmbOnboardingStep === 2 && (
                      <div className="max-w-xl mx-auto space-y-6">
                        <div className="text-center mb-6">
                          ...
                          <p className="text-sm text-muted-foreground">
                            Enter the address where customers can visit your business
                          </p>
                        </div>
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <Input
                              ...
                              value={gmbBusinessAddress}
                              onChange={(e) => setGmbBusinessAddress(e.target.value)}
                            />
                        ...
                        <div className="bg-muted/30 rounded-lg p-4">
                          ...
                          <p className="text-sm text-muted-foreground">
                            Your website will be set to: <span className="font-medium text-foreground">https://{selectedTrackedDomain || selectedDomainKey}</span>
                          </p>
                        </div>

                        <div className="flex justify-between pt-4">
                          <Button variant="outline" onClick={() => setGmbOnboardingStep(1)}>
                            <ChevronLeft className="w-4 h-4 mr-2" />
                            Back
                          </Button>
                          <Button
                            onClick={() => setGmbOnboardingStep(3)}
                            disabled={!gmbBusinessAddress}
                            className="bg-gradient-to-r from-blue-600 to-green-600 hover:from-blue-700 hover:to-green-700"
                          >
                            Continue
                            <ArrowRight className="w-4 h-4 ml-2" />
                    ...
                    {gmbOnboardingStep === 3 && (
                      <div className="max-w-xl mx-auto space-y-6">
                        <div className="text-center mb-6">
                          ...
                          <h3 className="text-xl font-bold mb-2">Complete Your Setup in Google</h3>
                          <p className="text-sm text-muted-foreground">
                            We've prepared your business information. Click below to complete the setup in Google Business Profile.
                          </p>
                        </div>
                        ...
                        <div className="bg-muted/30 rounded-xl p-6 space-y-3">
                          <div className="flex justify-between">
                            ...
                            <span className="text-sm font-medium">{gmbBusinessName}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-sm text-muted-foreground">Category</span>
                            <span className="text-sm font-medium capitalize">{gmbBusinessCategory.replace('_', ' ')}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-sm text-muted-foreground">Phone</span>
                            <span className="text-sm font-medium">{gmbBusinessPhone || 'Not provided'}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-sm text-muted-foreground">Address</span>
                            <span className="text-sm font-medium text-right max-w-[200px]">{gmbBusinessAddress}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-sm text-muted-foreground">Website</span>
                            <span className="text-sm font-medium">{selectedTrackedDomain || selectedDomainKey}</span>
                          </div>
                        </div>

                        <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                          <p className="text-sm text-blue-600 dark:text-blue-400">
                            <strong>Note:</strong> Google requires verification of business ownership. This typically involves receiving a postcard at your business address or phone verification.
                          </p>
                        </div>
                        ...
                        <div className="flex flex-col gap-3 pt-4">
                          <Button
                            size="lg"
                            onClick={() => {
                              const searchQuery = encodeURIComponent(`${gmbBusinessName} ${gmbBusinessAddress}`);
                              window.open(`https://business.google.com/create?hl=en&gmbsrc=ww-ww-et-gs-z-gmb-s-z-l~bhc-core-u%7Cgmb&ppsrc=GMBLR&utm_campaign=ww-ww-et-gs-z-gmb-s-z-l~bhc-core-u%7Cgmb&utm_source=gmb&utm_medium=et`, '_blank');
                              toast.success('Opening Google Business Profile setup...');
                            }}
                            className="bg-gradient-to-r from-blue-600 to-green-600 hover:from-blue-700 hover:to-green-700"
                          >
                          ...
                          <Button
                            ...
                            onClick={() => {
                              setGmbOnboardingStep(0);
                              setGmbBusinessName('');
                              setGmbBusinessCategory('');
                              setGmbBusinessAddress('');
                              setGmbBusinessPhone('');
                              toast.success('Setup saved. Complete in Google when ready.');
                            }}
                          >
