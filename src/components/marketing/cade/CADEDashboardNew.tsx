    ...
    <div className="space-y-6" style={{ contain: 'layout style' }}>
      ...
      <div className="relative rounded-2xl overflow-hidden border border-violet-500/30 bg-gradient-to-br from-violet-600/90 via-purple-600/90 to-violet-500/90 p-6 shadow-[0_0_30px_rgba(139,92,246,0.2)]">
        ...
        <div className="relative flex items-center justify-between gap-4">
          ...
          {/* Center: Website Connections - Compact */}
          <div className="flex items-center gap-3 px-4 py-2 rounded-xl bg-white/5 border border-white/10">
            <span className="text-[10px] text-white/50 uppercase tracking-wider whitespace-nowrap">Connections</span>
          ...
          <Button
            variant="ghost"
            size="icon"
            className="text-white/70 hover:text-white hover:bg-white/10 rounded-xl h-10 w-10 border border-white/10"
