    ...
    <div className="space-y-6" style={{ contain: 'layout style' }}>
      ...
      <div className="relative rounded-2xl overflow-hidden border border-violet-500/30 bg-gradient-to-br from-violet-600/90 via-purple-600/90 to-violet-500/90 p-6 shadow-[0_0_30px_rgba(139,92,246,0.2)]">
        ...
        <div className="relative flex items-center justify-between gap-6">
          ...
          {/* Center: Website Connections - Expanded */}
          <div className="flex-1 flex items-center justify-center">
            <div className="flex items-center gap-4 px-6 py-3 rounded-2xl bg-white/10 border border-white/20 backdrop-blur-sm shadow-[0_0_20px_rgba(255,255,255,0.05)]">
              <span className="text-xs text-white/60 uppercase tracking-widest font-medium">Connections</span>
                ...
                <a 
                  ...
                  className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all ${
                    domainContext?.social_links?.some((l: string) => l.includes('facebook'))
                      ? 'bg-blue-500/30 text-blue-300 hover:bg-blue-500/50 shadow-[0_0_15px_rgba(59,130,246,0.3)]'
                ...
                <a 
                  ...
                  className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all ${
                    domainContext?.social_links?.some((l: string) => l.includes('instagram'))
                      ? 'bg-gradient-to-br from-pink-500/30 to-purple-500/30 text-pink-300 hover:from-pink-500/50 hover:to-purple-500/50 shadow-[0_0_15px_rgba(236,72,153,0.3)]'
                      : 'bg-white/10 text-white/40 hover:bg-white/20 hover:text-white/60'
                  }`}
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a 
                  ...
                  className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all ${
                    domainContext?.social_links?.some((l: string) => l.includes('linkedin'))
                      ? 'bg-blue-600/30 text-blue-300 hover:bg-blue-600/50 shadow-[0_0_15px_rgba(37,99,235,0.3)]'
                      : 'bg-white/10 text-white/40 hover:bg-white/20 hover:text-white/60'
                  }`}
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a 
                  ...
                  className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all ${
                    domainContext?.social_links?.some((l: string) => l.includes('twitter') || l.includes('x.com'))
                      ? 'bg-white/30 text-white hover:bg-white/50 shadow-[0_0_15px_rgba(255,255,255,0.2)]'
                      : 'bg-white/10 text-white/40 hover:bg-white/20 hover:text-white/60'
                  }`}
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a 
                  ...
                  className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all ${
                    domainContext?.social_links?.some((l: string) => l.includes('youtube'))
                      ? 'bg-red-500/30 text-red-300 hover:bg-red-500/50 shadow-[0_0_15px_rgba(239,68,68,0.3)]'
                      : 'bg-white/10 text-white/40 hover:bg-white/20 hover:text-white/60'
                  }`}
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
