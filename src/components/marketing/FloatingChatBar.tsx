...
import { 
  MessageCircle, Send, X, Minimize2, Maximize2, User, Bell
} from 'lucide-react';
...
const FloatingChatBar = ({ isOnline, selectedChatId, onChatClose }: FloatingChatBarProps) => {
  ...
  return (
    <div className="fixed bottom-0 right-0 z-50 flex items-end gap-3 p-4" style={{ contain: 'layout paint' }}>
      ...
      {minimizedChats.length > 0 && (
        <div className="flex flex-col-reverse gap-1" style={{ contain: 'layout paint' }}>
