...
export const CADEPlatformConnect = ({ domain, onConnectionComplete }: CADEPlatformConnectProps) => {
  ...
  return (
    <motion.div
      ...
      className="relative"
    >
      {/* Main Container with gradient border - CADE violet/purple theme */}
      <div className="relative p-8 rounded-2xl bg-gradient-to-br from-violet-500/5 via-purple-500/10 to-fuchsia-500/5 border border-violet-500/20 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-4 mb-8">
            <div className="flex items-center gap-4">
              <motion.div
                ...
                className="w-16 h-16 rounded-2xl bg-gradient-to-br from-violet-400 to-purple-500 flex items-center justify-center shadow-xl"
              >
          ...
          <div className="grid grid-cols-3 gap-4 mb-8">
            {[
              ...
              <motion.div
                ...
                className="relative p-4 rounded-xl bg-background/50 border border-violet-500/10 text-center"
              >
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-6 h-6 rounded-full bg-gradient-to-br from-violet-400 to-purple-500 flex items-center justify-center text-white text-xs font-bold shadow-lg">
                  {item.step}
                </div>
                <div className="w-10 h-10 rounded-lg bg-violet-500/10 flex items-center justify-center mx-auto mt-2 mb-2">
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-6 pt-6 border-t border-violet-500/10"
          >
