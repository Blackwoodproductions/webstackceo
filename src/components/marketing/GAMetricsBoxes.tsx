...
export const GAMetricsBoxes = ({ metrics }: GAMetricsBoxesProps) => {
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-3 mb-4" style={{ contain: "layout" }}>
      {/* GA Header Badge */}
          ...
          <div className="relative z-10 flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="flex items-center gap-1 text-[8px] font-medium px-1.5 py-0.5 rounded-full bg-orange-500/20 text-orange-400 border border-orange-500/30">
