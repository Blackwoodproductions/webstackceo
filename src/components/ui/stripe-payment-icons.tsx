...
const StripeLogo = ({ className = "h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 60 25" xmlns="http://www.w3.org/2000/svg">
    <path
      fill="currentColor"
      d="M59.64 14.28h-8.06c.19 1.93 1.6 2.55 3.2 2.55 1.64 0 2.96-.37 4.05-.95v3.32a10.1 10.1 0 0 1-4.56 1c-4.01 0-6.83-2.5-6.83-7.12 0-3.74 2.32-7.05 6.18-7.05 3.52 0 5.92 2.6 5.92 6.78 0 .6-.05 1.08-.1 1.47zm-3.67-2.88c0-1.19-.77-2.7-2.33-2.7-1.7 0-2.44 1.47-2.55 2.7h4.88zM34.04 6.17c-1.55 0-2.75.53-3.38 1.27l-.23-1.01h-3.78v18.89l4.3-.9.01-4.52c.65.44 1.6.99 3.15.99 3.2 0 6.1-2.46 6.1-7.94-.01-4.5-2.83-6.78-6.17-6.78zm-1.09 10.42c-1.05 0-1.67-.36-2.1-.8l-.02-6.35c.46-.5 1.1-.84 2.12-.84 1.62 0 2.74 1.74 2.74 3.98 0 2.3-1.1 4.01-2.74 4.01zM24.37 3l-4.31.92v3.42h4.31V3zm0 3.92H20.06v12.84h4.31V6.92zM15.61 8.03l-.27-1.6H11.6v13.33h4.31V11.8c1.02-1.26 2.74-1.02 3.28-.85V6.44c-.55-.2-2.56-.57-3.58.99zm-9.08-.22c.84 0 1.46.14 2.27.48V4.44c-.82-.31-2.08-.62-3.47-.62-3.42 0-5.62 1.74-5.62 4.65 0 4.15 5.81 3.46 5.81 5.26 0 .87-.69 1.2-1.66 1.2-1.07 0-2.24-.35-3.37-.98v3.77c1.14.48 2.3.71 3.37.71 3.52 0 5.93-1.54 5.93-4.65 0-4.48-5.85-3.64-5.85-5.35 0-.73.61-1.07 1.59-1.07z"
    />
  </svg>
);
