...
// Simple Stripe text badge component - using forwardRef to avoid React warnings
const StripeLogo = forwardRef<HTMLSpanElement, { className?: string }>(
  ({ className = "h-6" }, ref) => (
    <span 
      ref={ref}
...
// Payment method card icons - using forwardRef to avoid React warnings with motion
const VisaIcon = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>((props, ref) => (
  <svg ref={ref} className="h-6 w-auto" viewBox="0 0 48 32" xmlns="http://www.w3.org/2000/svg" {...props}>
...
const MastercardIcon = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>((props, ref) => (
  <svg ref={ref} className="h-6 w-auto" viewBox="0 0 48 32" xmlns="http://www.w3.org/2000/svg" {...props}>
...
const AmexIcon = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>((props, ref) => (
  <svg ref={ref} className="h-6 w-auto" viewBox="0 0 48 32" xmlns="http://www.w3.org/2000/svg" {...props}>
...
const DiscoverIcon = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>((props, ref) => (
  <svg ref={ref} className="h-6 w-auto" viewBox="0 0 48 32" xmlns="http://www.w3.org/2000/svg" {...props}>
...
StripePaymentIcons.displayName = 'StripePaymentIcons';

// Compact inline version for trust indicators
export const StripeSecureBadge = memo(() => (
...
StripeSecureBadge.displayName = 'StripeSecureBadge';
