...
export const VIDashboardEffects = () => {
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
      ...
      {/* Corner gradient accents - static for performance */}
      <div 
      ...
      {/* Additional corner blobs - static */}
      <div 
      ...
      <div className="absolute top-[40%] left-[5%] w-1 h-1 rounded-full bg-cyan-300/40" />
      <div className="absolute top-[60%] right-[5%] w-1.5 h-1.5 rounded-full bg-violet-300/40" />
      <div className="absolute top-[5%] left-[40%] w-1 h-1 rounded-full bg-primary/40" />
      <div className="absolute bottom-[10%] right-[30%] w-2 h-2 rounded-full bg-cyan-400/40" />
      <div className="absolute top-[70%] left-[25%] w-1.5 h-1.5 rounded-full bg-amber-300/40" />
      <div className="absolute top-[35%] right-[35%] w-1 h-1 rounded-full bg-emerald-300/30" />
