        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          {user ? (
            ...
            <>
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="heroOutline" size="sm" className="transition-all duration-300 hover:border-amber-400/50 hover:text-amber-400 hover:shadow-[0_0_20px_rgba(251,191,36,0.3)]">
                    Login
                ...
                <DropdownMenuContent align="end" className="w-56 bg-background border border-border z-50">
                  ...
                  <DropdownMenuSeparator />
                  <DropdownMenuItem asChild>
                    <a href="/auth?redirect=/visitor-intelligence-dashboard" className="flex items-center gap-3 cursor-pointer">
